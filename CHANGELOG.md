...
- O `kickoff` deixou de ser bilhete vago para host improvisar. `start --format json` agora expõe `kickoff_contract` e `initial_question`, para a primeira sessão nascer com disciplina, destino e um mínimo de utilidade.
