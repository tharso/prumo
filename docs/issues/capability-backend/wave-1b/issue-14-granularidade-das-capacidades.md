...
Capability demais e como talher de restaurante metido a besta: bonito no guardanapo, inutil quando o usuario so quer jantar sem cerimônia. Se cada resposta exigir uma procissao de tool calls, a fluidez morre na fila.
...
1. [issue-11-contrato-de-orquestracao.md](/Users/tharsovieira/Documents/DailyLife/Prumo/docs/issues/capability-backend/wave-1b/issue-11-contrato-de-orquestracao.md)
2. [issue-28-adapter-antigravity-e-validacao.md](/Users/tharsovieira/Documents/DailyLife/Prumo/docs/issues/capability-backend/wave-1a/issue-28-adapter-antigravity-e-validacao.md)
