...
- `skills/prumo/references/email-snapshot-personal-template.gs`
- `skills/prumo/references/email-snapshot-work-template.gs`
...
5. Cole o conteúdo de `skills/prumo/references/email-snapshot-personal-template.gs` em `Code.gs`.
...
6. Cole o conteúdo de `skills/prumo/references/email-snapshot-work-template.gs` em `Code.gs`.
